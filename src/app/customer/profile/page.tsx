...
export default function CustomerProfilePage() {
	...
	const onProfileSubmit = async (data: ProfileFormData) => {
		try {
			...
			// Invalidate and refetch the user query to update the UI everywhere
						...
						<Form {...profileForm}>
							...
							>
								...
								<Button
									type="submit"
									disabled={
										!isProfileDirty || !isProfileValid || isProfileSubmitting
									}
								>
						...
						{isSupported ? (
							<>
								{platformInfo.needsPWAInstall && (
									<div
										className="bg-yellow-100 dark:bg-yellow-900/20 border-l-4 border-yellow-500 text-yellow-700 dark:text-yellow-300 p-4"
										role="alert"
									>
										<p className="font-bold">Enable Notifications on iOS</p>
										<p>
											To get notifications, you must add this app to your Home
											Screen. Tap the Share icon and then 'Add to Home Screen'.
										</p>
									</div>
								)}

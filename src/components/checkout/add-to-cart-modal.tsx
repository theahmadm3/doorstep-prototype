...
export default function AddToCartModal({ isOpen, onClose, item, onAddToCart }: AddToCartModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold text-center">{item.name}</DialogTitle>
        </DialogHeader>
        <div className="py-4">
